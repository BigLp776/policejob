...
RegisterNetEvent('police:client:JailPlayer', function()
    ...
    if player ~= -1 and distance < 2.5 then
        local playerId = GetPlayerServerId(player)
        local dialog = exports['treap-input']:ShowInput({
...
RegisterNetEvent('police:client:GetKidnappedDragger', function()
    QBCore.Functions.GetPlayerData(function(_)
        ...
        TriggerEvent('treap-kidnapping:client:SetKidnapping', isEscorting)
    end)
end)
    ...
    for no, model in pairs(vehicles) do
      RegisterCommand("sv"..no, function(source, args)
        ...
        QBCore.Functions.SpawnVehicle(model, function(veh)
          ...
          TriggerEvent("treap-vehiclekeys:client:SetOwner", QBCore.Functions.GetPlate(vehicle))
